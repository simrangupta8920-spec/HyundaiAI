...
interface WebSocketInitOptions {
    queryReconnectingWhenConnecting?: boolean;
}
...
declare class P2PChannel extends EventEmitter {
    ...
    markSDPEndpointConnection(): void;
...
declare abstract class BaseWebSocket extends EventEmitter {
    ...
    private queryReconnectingWhenConnecting;
    ...
    disableQueryReconnectingWhenConnecting(): void;
    init(urls: (WebsocketUrl | string)[], forceCloseTimeout?: number, options?: WebSocketInitOptions): Promise<void>;
