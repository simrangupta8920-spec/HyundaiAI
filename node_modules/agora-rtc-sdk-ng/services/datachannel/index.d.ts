...
import { ServerAddress, RTPCapabilitiesWithDirection, RTPCapabilitiesBeforeMerge } from '@agora-js/protocol';
...
declare abstract class P2PConnectionBaseImpl extends EventEmitter {
    ...
    onAudioMetadata?: (metadata: Uint8Array) => void;
    onAudioPts?: (pts: bigint) => void;
...
declare abstract class P2PConnectionImpl extends P2PConnectionBaseImpl {
    ...
    abstract updateRemoteConnect(connectParams: {
